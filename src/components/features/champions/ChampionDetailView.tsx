      ...
      <div className="grid gap-0 lg:grid-cols-[1.1fr_0.9fr]">
        ...
        <CardContent className="flex flex-col justify-between gap-8 p-6 sm:p-8">
          <div className="space-y-4">
            ...
            <p className="rounded-lg border border-border/70 bg-background/60 px-3 py-2 text-sm leading-relaxed text-foreground/85">
              {champion.lore ?? 'Lore no disponible para este campeon en el dataset actual.'}
            </p>
          </div>
